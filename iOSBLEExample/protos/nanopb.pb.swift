...
extension IntSize: CaseIterable {
  // Support synthesized by the compiler.
}
...
extension FieldType: @unchecked Sendable {}
extension IntSize: @unchecked Sendable {}
extension NanoPBOptions: @unchecked Sendable {}
...
extension NanoPBOptions: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try { try decoder.decodeSingularBoolField(value: &self._longNames) }()
      case 5: try { try decoder.decodeSingularBoolField(value: &self._packedStruct) }()
      case 6: try { try decoder.decodeSingularBoolField(value: &self._skipMessage) }()
      case 7: try { try decoder.decodeSingularEnumField(value: &self._intSize) }()
      case 8: try { try decoder.decodeSingularBoolField(value: &self._noUnions) }()
      case 9: try { try decoder.decodeSingularUInt32Field(value: &self._msgid) }()
      case 10: try { try decoder.decodeSingularBoolField(value: &self._packedEnum) }()
      case 11: try { try decoder.decodeSingularBoolField(value: &self._anonymousOneof) }()
      case 12: try { try decoder.decodeSingularBoolField(value: &self._proto3) }()
      case 13: try { try decoder.decodeSingularBoolField(value: &self._enumToString) }()
      case 14: try { try decoder.decodeSingularInt32Field(value: &self._maxLength) }()
      case 15: try { try decoder.decodeSingularBoolField(value: &self._fixedLength) }()
      case 16: try { try decoder.decodeSingularBoolField(value: &self._fixedCount) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._longNames {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 4)
    } }()
    try { if let v = self._packedStruct {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 5)
    } }()
    try { if let v = self._skipMessage {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 6)
    } }()
    try { if let v = self._intSize {
      try visitor.visitSingularEnumField(value: v, fieldNumber: 7)
    } }()
    try { if let v = self._noUnions {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 8)
    } }()
    try { if let v = self._msgid {
      try visitor.visitSingularUInt32Field(value: v, fieldNumber: 9)
    } }()
    try { if let v = self._packedEnum {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 10)
    } }()
    try { if let v = self._anonymousOneof {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 11)
    } }()
    try { if let v = self._proto3 {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 12)
    } }()
    try { if let v = self._enumToString {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 13)
    } }()
    try { if let v = self._maxLength {
      try visitor.visitSingularInt32Field(value: v, fieldNumber: 14)
    } }()
    try { if let v = self._fixedLength {
      try visitor.visitSingularBoolField(value: v, fieldNumber: 15)
    } }()
    try { if let v = self._fixedCount {
  ...
  static func ==(lhs: NanoPBOptions, rhs: NanoPBOptions) -> Bool {
    ...
    if lhs._intSize != rhs._intSize {return false}
    if lhs._type != rhs._type {return false}
    if lhs._longNames != rhs._longNames {return false}
    if lhs._packedStruct != rhs._packedStruct {return false}
    if lhs._packedEnum != rhs._packedEnum {return false}
    if lhs._skipMessage != rhs._skipMessage {return false}
    if lhs._noUnions != rhs._noUnions {return false}
    if lhs._msgid != rhs._msgid {return false}
    if lhs._anonymousOneof != rhs._anonymousOneof {return false}
    if lhs._proto3 != rhs._proto3 {return false}
    if lhs._enumToString != rhs._enumToString {return false}
    if lhs._fixedLength != rhs._fixedLength {return false}
    if lhs._fixedCount != rhs._fixedCount {return false}
