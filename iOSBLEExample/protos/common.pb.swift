...
struct Particle_Ctrl_IpAddress {
  ...
  var address: Particle_Ctrl_IpAddress.OneOf_Address? = nil
...
extension Particle_Ctrl_ResultCode: @unchecked Sendable {}
extension Particle_Ctrl_Ipv4Address: @unchecked Sendable {}
extension Particle_Ctrl_Ipv6Address: @unchecked Sendable {}
extension Particle_Ctrl_IpAddress: @unchecked Sendable {}
extension Particle_Ctrl_IpAddress.OneOf_Address: @unchecked Sendable {}
extension Particle_Ctrl_IPAddress: @unchecked Sendable {}
extension Particle_Ctrl_IPAddress.ProtocolEnum: @unchecked Sendable {}
...
extension Particle_Ctrl_Ipv4Address: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFixed32Field(value: &self.address) }()
      default: break
      }
    }
  }
