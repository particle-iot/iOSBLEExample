...
struct Particle_Ctrl_Mesh_CreateNetworkReply {
  ...
  var network: Particle_Ctrl_Mesh_NetworkInfo {
    get {return _network ?? Particle_Ctrl_Mesh_NetworkInfo()}
  ...
  fileprivate var _network: Particle_Ctrl_Mesh_NetworkInfo? = nil
}
...
struct Particle_Ctrl_Mesh_DiagnosticInfo {
  ...
  struct NetworkData {
    ...
    var stable: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage {
      get {return _stable ?? Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage()}
    ...
    var temporary: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage {
      get {return _temporary ?? Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage()}
      set {_temporary = newValue}
    }
    /// Returns true if `temporary` has been explicitly set.
    var hasTemporary: Bool {return self._temporary != nil}
    /// Clears the value of `temporary`. Subsequent reads from it will return its default value.
    mutating func clearTemporary() {self._temporary = nil}
    ...
    struct Prefix {
      ...
      var hasRoute_p: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute {
        get {return _hasRoute_p ?? Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute()}
        set {_hasRoute_p = newValue}
      }
      /// Returns true if `hasRoute_p` has been explicitly set.
      var hasHasRoute_p: Bool {return self._hasRoute_p != nil}
      /// Clears the value of `hasRoute_p`. Subsequent reads from it will return its default value.
      mutating func clearHasRoute_p() {self._hasRoute_p = nil}

      var borderRouter: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter {
        get {return _borderRouter ?? Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter()}
        set {_borderRouter = newValue}
      }
      /// Returns true if `borderRouter` has been explicitly set.
      var hasBorderRouter: Bool {return self._borderRouter != nil}
      /// Clears the value of `borderRouter`. Subsequent reads from it will return its default value.
      mutating func clearBorderRouter() {self._borderRouter = nil}

      var unknownFields = SwiftProtobuf.UnknownStorage()

      init() {}

      fileprivate var _hasRoute_p: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute? = nil
      fileprivate var _borderRouter: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter? = nil
    }
    ...
    fileprivate var _stable: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage? = nil
    fileprivate var _temporary: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage? = nil
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter.BorderRouterEntry.Flags: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter.BorderRouterEntry.Flags] = [
    .none,
    .preferred,
    .slaac,
    .dhcp,
...
extension Particle_Ctrl_Mesh_DiagnosticType: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_NetworkInfo: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_AuthRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_AuthReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_CreateNetworkRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_CreateNetworkReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_StartCommissionerRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_StartCommissionerReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_StopCommissionerRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_StopCommissionerReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_PrepareJoinerRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_PrepareJoinerReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_AddJoinerRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_AddJoinerReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_RemoveJoinerRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_RemoveJoinerReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_JoinNetworkRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_JoinNetworkReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_LeaveNetworkRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_LeaveNetworkReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_GetNetworkInfoRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_GetNetworkInfoReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_ScanNetworksRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_ScanNetworksReply: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.Mode: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.RoutePreference: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.Connectivity: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.Route64: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.Route64.RouteData: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.LeaderData: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute.HasRouteEntry: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter.BorderRouterEntry: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.BorderRouter.BorderRouterEntry.Flags: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Context: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Prefix: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Server: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Service: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.MacCounters: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.ChildTable: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_DiagnosticInfo.ChildTable.ChildEntry: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_GetNetworkDiagnosticsRequest: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_GetNetworkDiagnosticsRequest.Flags: @unchecked Sendable {}
extension Particle_Ctrl_Mesh_GetNetworkDiagnosticsReply: @unchecked Sendable {}
...
extension Particle_Ctrl_Mesh_NetworkInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularStringField(value: &self.extPanID) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.panID) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.channel) }()
      case 5: try { try decoder.decodeSingularStringField(value: &self.networkID) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_PrepareJoinerReply: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularStringField(value: &self.eui64) }()
      case 2: try { try decoder.decodeSingularStringField(value: &self.password) }()
      default: break
      }
    }
...
extension Particle_Ctrl_Mesh_ScanNetworksRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.duration) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        // enabled. https://github.com/apple/swift-protobuf/issues/1034
        switch fieldNumber {
        case 1: try { try decoder.decodeSingularBytesField(value: &_storage._extMacAddress) }()
        case 2: try { try decoder.decodeSingularUInt32Field(value: &_storage._rloc) }()
        case 3: try { try decoder.decodeSingularUInt32Field(value: &_storage._mode) }()
        case 4: try { try decoder.decodeSingularUInt32Field(value: &_storage._timeout) }()
        case 5: try { try decoder.decodeSingularMessageField(value: &_storage._connectivity) }()
        case 6: try { try decoder.decodeSingularMessageField(value: &_storage._route64) }()
        case 7: try { try decoder.decodeSingularMessageField(value: &_storage._leaderData) }()
        case 8: try { try decoder.decodeSingularMessageField(value: &_storage._networkData) }()
        case 9: try { try decoder.decodeRepeatedMessageField(value: &_storage._ipv6AddressList) }()
        case 10: try { try decoder.decodeSingularMessageField(value: &_storage._macCounters) }()
        case 15: try { try decoder.decodeSingularUInt32Field(value: &_storage._batteryLevel) }()
        case 16: try { try decoder.decodeSingularUInt32Field(value: &_storage._supplyVoltage) }()
        case 17: try { try decoder.decodeSingularMessageField(value: &_storage._childTable) }()
        case 18: try { try decoder.decodeSingularBytesField(value: &_storage._channelPages) }()
        case 19: try { try decoder.decodeRepeatedEnumField(value: &_storage._typeList) }()
        case 20: try { try decoder.decodeSingularUInt32Field(value: &_storage._maxChildTimeout) }()
        case 100: try { try decoder.decodeSingularBytesField(value: &_storage._deviceID) }()
        default: break
        }
      }
    }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      try { if let v = _storage._connectivity {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
      } }()
      try { if let v = _storage._route64 {
        try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
      } }()
      try { if let v = _storage._leaderData {
      ...
      try { if let v = _storage._macCounters {
      ...
      try { if let v = _storage._childTable {
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.Connectivity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.parentPriority) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.linkQuality1) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.linkQuality2) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.linkQuality3) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.leaderCost) }()
      case 6: try { try decoder.decodeSingularUInt32Field(value: &self.idSequence) }()
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.activeRouters) }()
      case 8: try { try decoder.decodeSingularUInt32Field(value: &self.sedBufferSize) }()
      case 9: try { try decoder.decodeSingularUInt32Field(value: &self.sedDatagramCount) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.Route64: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.idSequence) }()
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.Route64.RouteData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.routerRloc) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.linkQualityOut) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.linkQualityIn) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.routeCost) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.LeaderData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.partitionID) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.weighting) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.dataVersion) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.stableDataVersion) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.leaderRloc) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularMessageField(value: &self._temporary) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.HasRoute.HasRouteEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.rloc) }()
      case 2: try { try decoder.decodeSingularEnumField(value: &self.preference) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Context: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.cid) }()
      case 2: try { try decoder.decodeSingularBoolField(value: &self.compress) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.contextLength) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Prefix: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.domainID) }()
      ...
      case 5: try { try decoder.decodeSingularMessageField(value: &self._hasRoute_p) }()
      case 6: try { try decoder.decodeSingularMessageField(value: &self._borderRouter) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    // https://github.com/apple/swift-protobuf/issues/1182
    if self.domainID != 0 {
      try visitor.visitSingularUInt32Field(value: self.domainID, fieldNumber: 1)
    }
    ...
    try { if let v = self._hasRoute_p {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
    } }()
    try { if let v = self._borderRouter {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }
  ...
  static func ==(lhs: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Prefix, rhs: Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Prefix) -> Bool {
    ...
    if lhs._hasRoute_p != rhs._hasRoute_p {return false}
    if lhs._borderRouter != rhs._borderRouter {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.Service: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.sid) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.enterpriseNumber) }()
      case 3: try { try decoder.decodeSingularBytesField(value: &self.data) }()
      case 4: try { try decoder.decodeRepeatedMessageField(value: &self.servers) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.NetworkData.DataMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.prefixes) }()
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.MacCounters: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.ifInUnknownProtos) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.ifInErrors) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.ifOutErrors) }()
      case 4: try { try decoder.decodeSingularUInt32Field(value: &self.ifInUcastPkts) }()
      case 5: try { try decoder.decodeSingularUInt32Field(value: &self.ifInBroadcastPkts) }()
      case 6: try { try decoder.decodeSingularUInt32Field(value: &self.ifInDiscards) }()
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.ifOutUcastPkts) }()
      case 8: try { try decoder.decodeSingularUInt32Field(value: &self.ifOutBroadcastPkts) }()
      case 9: try { try decoder.decodeSingularUInt32Field(value: &self.ifOutDiscards) }()
      default: break
      }
    }
  }
...
extension Particle_Ctrl_Mesh_DiagnosticInfo.ChildTable.ChildEntry: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt32Field(value: &self.timeout) }()
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.childID) }()
...
extension Particle_Ctrl_Mesh_GetNetworkDiagnosticsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeRepeatedEnumField(value: &self.diagnosticTypes) }()
      case 3: try { try decoder.decodeSingularUInt32Field(value: &self.timeout) }()
      default: break
      }
    }
